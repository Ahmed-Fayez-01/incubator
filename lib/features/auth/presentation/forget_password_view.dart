...
import 'package:incubator/features/auth/presentation/verification_view.dart';
                ...
                listener: (context, state) {
                  if (state is ForgetPasswordSuccessState) {
                    ...
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => VerificationView(email: email.text)));
                      ...
                      : DefaultButton(
                          onPress: () {
                            if (formKey.currentState!.validate()) {
                              context.read<ForgetPasswordCubit>().forgetPassword(email: email.text);
                            }
                          },
                          text: "Send Code",
