...
import '../../../../upload_file/presentation/view/upload_file_view.dart';
import '../../../../visiting/presentation/view/visiting_view.dart';

class CaseDetailsViewBody extends StatelessWidget {
  const CaseDetailsViewBody({super.key, required this.instance});
          ...
          child: Row(
            children: [
              Expanded(child: DefaultButton(onPress: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>  UploadFileView(caseId: instance.sId!,)));

              }, height: AppConstant.height10(context), text: "Add Report",icon: SvgPicture.asset(AssetData.phFile,color: Colors.white,width: MediaQuery.of(context).size.height*.035,),borderRadius: AppConstant.sp30(context),)),
              SizedBox(width: AppConstant.width20(context),),
              Expanded(child: DefaultButton(onPress: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=> const VisitingView()));

              }, height: AppConstant.height10(context),text: "Add Visit",icon: SvgPicture.asset(AssetData.time,color: Colors.white,width: MediaQuery.of(context).size.height*.035,),borderRadius: AppConstant.sp30(context),)),
            ],
          ),
        ),
        SizedBox(height: AppConstant.height20(context),),
